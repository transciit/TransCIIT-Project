...
const BottomNavBar = ({ currentTab }: Props) => {
  ...
  return (
    <Popover className="">
      <>
        <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2 sm:px-3.5 ">
          <div
          ...
          >
            <div
              className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-[#ffbcd8] to-[#948dff] opacity-30"
              style={{
                clipPath:
                  "polygon(74.8% 41.9%, 97.2% 73.2%, 100% 34.9%, 92.5% 0.4%, 87.5% 0%, 75% 28.6%, 58.5% 54.6%, 50.1% 56.8%, 46.9% 44%, 48.3% 17.4%, 24.7% 53.9%, 0% 27.9%, 11.9% 74.2%, 24.9% 54.1%, 68.6% 100%, 74.8% 41.9%)",
              }}
                ...
                <Link
                  ...
                  className={classNames(
                    item.name === currentTab
                      ...
                      : "text-gray-700 hover:bg-gray-700 hover:text-slate-50",
                    "px-3 py-1 rounded-md text-sm uppercase font-semibold"
                  )}
