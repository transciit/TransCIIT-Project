      ...
      >
        <div>
          <div className="mb-8 px-8 text-gray-100">
            <div className="mx-auto mt-10 grid max-w-screen-xl grid-cols-1 gap-8 px-8  text-gray-900  md:grid-cols-2 md:px-10 lg:px-10 xl:px-12">
              ...
              <div className="">
                <div>
                  ...
                  <input
                    className="mt-2 w-full rounded-lg bg-gray-300 p-3 text-gray-900 focus:outline-none"
                    type="text"
                    placeholder=""
                  />
                </div>
                ...
                <div className="mt-8">
                  ...
                  <textarea className="mt-2 h-32 w-full rounded-lg bg-gray-300 p-3 text-gray-900 focus:outline-none"></textarea>
                </div>
                <div className="mt-8">
                  <button className="w-full rounded-lg bg-indigo-500 p-3 text-sm font-bold uppercase tracking-wide text-gray-100 focus:outline-none">
                    Send Message
                  </button>
                </div>
              </div>
