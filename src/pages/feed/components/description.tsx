      ...
      <div className="top-6 grid grid-cols-3" key={feedDetails.id}>
        <div className="col-span-3 mb-28 grid rounded-xl border border-slate-300 bg-white p-1 md:mb-24 lg:col-span-2 lg:mb-0">
          <div className="mt-10 sm:mt-0">
            ...
            <div className="mt-1 mb-3 px-5 font-playfair text-xl font-extrabold text-slate-700 sm:text-2xl">
              {feedDetails.business_name}
            </div>
            <div className="ml-5 mb-7 items-center rounded-md text-base font-normal text-primary-500">
              By {feedDetails.author_name}
            </div>

            <div>
              <div>
                <div className="m-3 mb-2 px-2 text-base font-medium text-slate-700 sm:text-xl">
                  {feedDetails.business_primary_need}
                </div>
                ...
                <div className="mx-3 mb-3 px-2 text-base text-slate-600 line-clamp-3">
                  {feedDetails.business_primary_gap_details}
                </div>
                ...
                <div className="mx-3 flex justify-start px-2">
                  {feedDetails.business_primary_area_expertise?.map((item) => (
                    <button
                      type="button"
                      key={item}
                      className="mr-2 mb-2 rounded-full border border-slate-300 bg-slate-100 py-[6px] px-5 text-sm text-slate-600 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                    >
                      {item}
                    </button>
                  ))}
                ...
                <div className="grid grid-cols-2 divide-x">
                  <div>
                    ...
                    <div className="mx-3 mb-3 px-2 text-base text-slate-600">
                      {feedDetails.business_secondary_need}
                    </div>
                  </div>
                  <div>
                    <div className="relative mx-5 items-center self-center overflow-hidden text-gray-600 focus-within:text-gray-400">
                    ...
                    <div className="mx-3 px-2">
                      {feedDetails.business_secondary_area_expertise?.map(
                        (item) => (
                          <button
                            type="button"
                            key={item}
            ...
            <div className="mx-5 mt-5">
              {from.includes('invested') ? (
                ...
                <>
                  <button
                    type="button"
                    className="mb-2 w-full rounded-full bg-indigo-800 px-5 py-3 text-sm font-semibold text-white hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 md:mr-2"
                  >
                    Match Project
                  </button>
                </>
              ...
              <button
                type="button"
                className="mb-2 w-full rounded-full border border-gray-300 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700"
              >
                Talk to Student
              </button>
            </div>
            <div className="ml-5 mb-3 items-center rounded-md text-sm font-medium text-primary-600">
              Contact Support for help!
            </div>

            <div>
              <div>
                <div className="m-3 mb-2 px-2 text-xl font-medium text-slate-700"></div>
                <div className="mt-3 mb-2 flex w-full"></div>
                <hr className="my-3 h-px border-0 bg-gray-300 dark:bg-gray-700" />
                <div>
                  ...
                  <div className="mx-3 mb-3 px-2 text-base text-indigo-600">
                    {feedDetails.business_help_required}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mx-5 mt-5 grid grid-rows-2 md:grid-cols-2 md:grid-rows-none">
            {from.includes('invested') ? (
              ...
              <>
                ...
                <button
                  type="button"
                  className="mb-2 w-full rounded-full border border-indigo-500 bg-white px-5 py-2.5 text-sm font-semibold text-indigo-600 hover:bg-slate-100 hover:text-indigo-600 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:border-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-700 md:ml-2"
                >
                  Talk to Student
                </button>
              </>
