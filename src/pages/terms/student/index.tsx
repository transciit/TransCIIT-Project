  ...
  const handleInvite = async () => {
    try {
      await addDoc(collection(db, "bids"), {
        ...
        entrepreneur_id: router?.query?.uid,
      ...
      await addDoc(collection(db, "mail"), {
        ...
        template: {
          name: "invites",
          data: {
            main: `${router?.query?.fn} ${router?.query?.ln} has bidded on your project`,
            subject: `${router?.query?.fn} ${router?.query?.ln} has asked to match with your project, ${feedDetail[0].primary_need}`,
  ...
  return (
    <>
      <DashBoard
        metaDashboard={
          <Meta
            title="Bid Project | TransCIIT Project"
                  ...
                  <div className="mt-10 sm:mt-0">
                    ...
                    <div className="relative mx-5 items-center self-center overflow-hidden text-slate-600 focus-within:text-gray-400">
                      <div className="mb-4 text-xs font-normal text-gray-600">
                        This information will be visible by the entrepreneur
                      </div>
                    </div>
                        ...
                        <div className="sm:overflow-hidden">
                          <div className="space-y-6 px-4 py-2 sm:p-5">
                              ...
                              <div>
                                <div className="mr-2">
                                  ...
                                  <div className="mt-2 text-xs font-normal text-slate-700">
                                    Specify the estimated duration of the
                                    Project.
                                  </div>
                                </div>
                              </div>
                              ...
                              <div>
                                <div className="mr-2">
                                  <label
                                    ...
                                    className="block text-base font-medium text-slate-900"
                                  >
                                    What is the rate you&apos;d like to bid?
                                  </label>
                                  <div className="mt-1 flex rounded-md">
                                    <div className="flex">
                                      <span className="inline-flex items-center rounded-l-md border border-r-0 border-slate-400 bg-gray-200 px-3 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-600 dark:text-gray-400">
                                  ...
                                  <div className="mt-2 text-xs font-normal text-slate-700">
                                    If you don&apos;t have an amount you can
                                    type 0.
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="pt-5 text-xs font-normal text-gray-600">
                              This information will be visible by the
                              entrepreneur. By proceeding you agree to the
                              TransCIIT Project&apos;s{" "}
                              <a
                                href="#"
